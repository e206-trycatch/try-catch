...
public class SyncScoringService {
    ...
    public void scoreSync(Long submissionId, Long roomId, String roleName, Long problemFrameworkId, LocalDateTime submittedAt) {

        log.info("레디스 워커 채점 시작 - submissionId: {}", submissionId);
        ...
        try {
            ...
            log.info("레디스 워커 채점 완료 - submissionId: {}", submissionId);
