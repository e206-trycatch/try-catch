...
FRAMEWORK_CONFIGS = {
    "django": {
        "expert": "Django 프레임워크",
        "good_examples": [
            "DOC의 현재 상황에 에러 정보가 있어요. 그 에러가 무엇을 의미하는지 찾아보면 원인을 좁힐 수 있을 거예요.",
            "좋은 방향이에요! Django에서 그 부분을 처리하는 설정이 따로 있는데, 어떤 파일에서 관리하는지 생각해보세요.",
            "맞아요! 그 부분이 원인이에요. urls.py에서 해당 URL 패턴의 뷰 연결을 수정하세요.",
        ],
    ...
    "spring": {
        ...
        "good_examples": [
            "DOC의 현재 상황에 에러 정보가 있어요. 그 에러가 무엇을 의미하는지 찾아보면 원인을 좁힐 수 있을 거예요.",
            "좋은 방향이에요! 요청 메서드와 서버 설정이 일치하는지 확인해보세요.",
            "맞아요! 그 부분이 원인이에요. @PostMapping으로 변경하세요.",
        ],
    ...
    "vue": {
        ...
        "good_examples": [
            "DOC의 현재 상황에 에러 정보가 있어요. 그 에러가 무엇을 의미하는지 찾아보면 원인을 좁힐 수 있을 거예요.",
            "좋은 방향이에요! Vue에서 데이터가 바뀌면 화면에 반영되려면 어떤 조건이 필요한지 생각해보세요.",
            "맞아요! 그 부분이 원인이에요. ref()로 감싸서 반응형으로 만들어주세요.",
        ],
    ...
    "react": {
        ...
        "good_examples": [
            "DOC의 현재 상황에 에러 정보가 있어요. 그 에러가 무엇을 의미하는지 찾아보면 원인을 좁힐 수 있을 거예요.",
            "좋은 방향이에요! 컴포넌트가 마운트될 때 데이터를 불러오는 패턴을 생각해보세요.",
            "맞아요! 그 부분이 원인이에요. useEffect의 의존성 배열을 수정하세요.",
        ],
    ...
    "fullstack": {
        "expert": "풀스택 웹 개발",
        "good_examples": [
            "DOC의 현재 상황에 프론트엔드와 백엔드 각각의 에러 정보가 있어요. 하나씩 확인해보세요.",
            "좋은 방향이에요! 해당 에러가 프론트엔드 쪽인지 백엔드 쪽인지 구분해서 확인해보세요.",
            "맞아요! 그 부분이 원인이에요. 해당 설정을 수정하세요.",
        ],
